...
onMounted(() => {
    ...
    opcionesConDesplegable.forEach((opcion) => {
        opcion.querySelector(".opcion-con-desplegable-item").addEventListener("click", () => {
    ...
    <div class="flex h-screen">
        <div class="flex-1 flex flex-col overflow-hidden">
            <div class="flex h-full">
                ...
                <nav class="flex w-72 h-full bg-gray-100 shadow-sm">
                    <div class="w-full flex mx-auto px-4 py-8">
                        <div class="w-full h-full flexr">
                            <div class="h-10 self-center m-3 mb-4">
                                <img class="h-10 self-center" :src="logo"/>
                            </div>
                            <div>
                                <span class="text-base text-gray-500 font-bold">{{ $page.props.auth.user.name }}</span>
                            </div>
                            <ul class="space-y-2 mt-5 text-gray-800">
                                <li class="opcion-con-desplegable">
                                    <div class="opcion-con-desplegable-item flex items-center justify-between p-3 bg-white hover:shadow-sm align-middle transition-all ease-in  rounded-xl
                                    disabled:opacity-50 disabled:shadow-none disabled:cursor-not-allowed
                                    focus:shadow-none duration-150
                                    hover:border-stone-600 hover:opacity-60 hover:cursor-pointer
                                        ">
                                        <div class="flex">
                                            ...
                                            <span class="ml-2 text-base">Отзывы</span>
                                        </div>
                                    </div>
                                    <ul class="desplegable mt-2">
                                        <li class="mb-1">
                                            <Link href="/"
                                                  class="block p-[4px]  flex align-middle transition-all ease-in  rounded-full
                                    disabled:opacity-50 disabled:shadow-none disabled:cursor-not-allowed
                                    focus:shadow-none duration-150 pl-10
                                    "
                                                  :class="{
                                                'bg-white shadow-xs pointer-events-none': $page.url === '/',
                                                'hover:cursor-pointer hover:shadow-sm hover:bg-white': $page.url !== '/',
                                            }"
                                            >
                                                Отзывы
                                            </Link>
                                        ...
                                        <li class="mb-1">
                                            <Link href="/settings" class="block p-[4px] flex
                                            align-middle transition-all ease-in  rounded-full
                                    disabled:opacity-50 disabled:shadow-none disabled:cursor-not-allowed
                                    focus:shadow-none duration-150 pl-10
                                   "
                                                  :class="{
                                                'bg-white shadow-xs pointer-events-none': $page.url === '/settings',
                                                ' hover:cursor-pointer hover:shadow-sm hover:bg-white': $page.url !== '/settings',
                                            }"
                                            >
                                                Настройки
                                            </Link>
                ...
                <main class="h-full flex flex-col w-full mb-14  divide-y-1 divide-gray-200 bg-white">
                    ...
                    <div class="flex w-full mx-auto px-6 py-8 overflow-x-hidden overflow-y-auto bg-white">
